...
- A new RenderContext for WPF that renders into DrawingGroup instead of creating WPF elements. Adding WPF elements during render can block rendering when there are a lot of series.
